...
class ItemRequestControllerTest {
    ...
    void addNewRequest() throws Exception {
        ...
        mvc.perform(post("/requests")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.description", Matchers.is(itemRequestDto.getDescription())));
    ...
    void getRequestsByUserId() throws Exception {
        ...
        mvc.perform(get("/requests")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].description", Matchers.is(itemRequestDto.getDescription())));
    }
